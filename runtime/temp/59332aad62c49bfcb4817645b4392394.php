<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:55:"E:\git\TpStage/apps/backend\view\admin_group\index.html";i:1531560119;s:49:"E:\git\TpStage\apps\backend\view\common\base.html";i:1531559955;s:51:"E:\git\TpStage\apps\backend\view\common\header.html";i:1531559973;s:49:"E:\git\TpStage\apps\backend\view\common\menu.html";i:1531106323;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<article class="cl pd-20">
			<form action="<?=url('')?>">
				<div class="text-c input-search">
					...
					<input type="text" name="title" value="<?php echo \think\Request::instance()->get('title'); ?>" placeholder="名称" class="input-text input-search-text">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<a class="btn btn-primary radius" href="<?=url('add')?>">添加角色</a>
			            ...
			            <table class="table table-border table-bordered table-hover table-striped table-list" id="DataTables_Table_0" role="grid" >
			                ...
			                <tbody>
			                	...
			                	<?php }else{ foreach ($list['data'] as $info) { ?>
				                		<tr class="text-c " role="row">
					                        <td><input type="checkbox" value="<?=$info['id']?>" class="info-id"></td>
					                        <td><?=$info['id']?></td>
					                        <td><?=$info['title']?></td>
					                        <td><?=$info['status_text']?></td>
					                        <td class="f-14 td-manage">
					                            <a class="ml-5 form-icon" href="<?=url('update',['id'=>$info['id']])?>" title="编辑"><i class="Hui-iconfont"></i></a>
					                            <a class="ml-5 do-del form-icon" data-url='<?=url("del")?>' href="javascript:;" title="删除"><i class="Hui-iconfont"></i></a>
					                        </td>
					                        <td class="f-14 td-manage">
					                        <a class="ml-5" href="<?=url('AdminAccess/index',['group_id'=>$info['id']])?>" title="关联"><span class="label label-primary form-span">关联</span></a>
					                        </td>
					                    </tr>
				                	<?php } } ?>
