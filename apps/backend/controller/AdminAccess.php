...
use think\Request;
use app\backend\model\AuthGroupAccess as MasterModel;

class AdminAccess extends Backend
{	
    ...
    public function index(){
        ...
        $this->assign('group_id', $postArr['group_id']);
    ...
    public function add(){
        if($this->request->isPost()){
            ...
            $postArr = $this->request->param();
            $info['group_id'] = $postArr['group_id'];
